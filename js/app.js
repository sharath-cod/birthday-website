...
const FIXED_PHOTOS = [
  ...
  { src: 'images/photo (4).jpg', caption: 'sunshine 🌸' },
  { src: 'images/photo (5).jpg', caption: 'sunshine 🌸' },
  { src: 'images/photo (6).jpg', caption: 'sunshine 🌸' },
  { src: 'images/photo (7).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (8).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (9).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (10).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (11).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (12).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (13).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (14).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (15).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (16).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (17).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (18).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (19).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (20).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (21).jpg', caption: 'sunshine 🌸' },
   { src: 'images/photo (22).jpg', caption: 'sunshine 🌸' },
